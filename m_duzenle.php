...
$k_tipi = 1;
    ...
    header("Location: m_management.php"); exit();
}
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <?= navbar("Müşteri Yönetimi", $username); ?>
                <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="col-md-11 m-4 d-flex justify-content-center">
                            <form method="POST" action="islem_m.php" id="myForm">
                            <input type="hidden" class="form-control" value="<?= $id_ ?>" name="id">
                                ...
                                <div class="row g-2 mb-4">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="js-example-basic-single" name="cinsiyet" id="cinsiyet" value="<?= $cinsiyet ?>" aria-label="Cinsiyet">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select class="js-example-basic-single" name="uyruk" id="uyruk" value="<?= $uyruk ?>" aria-label="Uyruk">
                                            <option value="uyruk1">Uyruk 1</option>
                                            <option value="236">Türk</option>
                                            <!-- Diğer uyruk seçenekleri -->
                                        </select>
                                    </div>
                                    <div class="col-md-2">
                                        <label for="ulke" class="form-label">Ülke</label>
                                        <select class="js-example-basic-single" name="ulke" id="ulke" value="<?= $ulke ?>" aria-label="Ülke">
                                            <option value="ulke1">Ülke 1</option>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select class="js-example-basic-single" name="sehir" id="sehir" value="<?= $sehir ?>" aria-label="Şehir">
                                            <option value="sehir1">Şehir 1</option>
                                            <option value="1166">Ankara</option>
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.10.1/dist/sweetalert2.all.min.js"></script>
    ...
    <?php
        ...
        echo "<script>select_box("."'k_tipi',"."'1'".");</script>";
