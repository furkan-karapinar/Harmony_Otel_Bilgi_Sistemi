...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $k_sifre = $_POST["sifre"];
    $rst = personel_guncelle($id_,$adi, $soyadi, $tc_no, $tel_no, $adres, $email, $dogum, $cinsiyet, $uyruk, $ulke, $sehir, $plaka, $k_tipi, $k_adi, $k_sifre);

    
    if ($rst == 1) {header("Location: p_management.php?islem=1"); exit();}
    else {header("Location: p_management.php?islem=2"); exit();}
